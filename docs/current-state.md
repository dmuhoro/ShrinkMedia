...
| C14 | Android instrumentation tests **written + executed on device** (JVM + instrumented) | ✅ | JVM unit tests green; 9/9 instrumented tests PASS on API-36 (Sprint 8 evidence `2026-08-31_device_verification.md`) |
